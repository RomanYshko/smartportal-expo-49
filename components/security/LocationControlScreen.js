...
class LocationControlScreen extends React.Component{
    ...
    componentDidMount(){
        ...
        TaskManager.defineTask(LOCATION_TRACKING, async ({ data, error }) => {
            ...
            if (data) {
                ...
                const selectedObjectId = this.props.selectedObjectId;
                ...
                axiosInstance.post('/mobile/guard/open_shift_route', null, {params: {
                    type: 'background', lat: lat, lon: long, guard_object_id: selectedObjectId} } );
            }
        });
    ...
    stopLocationBackgroundTracking(selectedObjectId){
        ...
        // Make call to open (create) shift
        axiosInstance.post('/mobile/guard/close_shift_route', null, {params: {
            type: 'background', guard_object_id: selectedObjectId} } );
    ...
    uiStartStopTrackingButton(){
        if(this.state.isTracking == true){
            return (<Button title="Stop background tracking" 
            color="red" onPress={() => {
            ...
            return (<Button title="Start background tracking" 
            color="green" 
            onPress={() => {
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps)(LocationControlScreen);